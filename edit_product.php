                    ...
                    <div>
                        ...
                        <form action="edit_product.php" method="post" enctype="multipart/form-data">
                            <div>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" value="<?php echo $pPrice; ?>" required placeholder="Product Price" name="pPrice">
                                    <label for="floatingPassword">Product Price</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" value="<?php echo $pCost; ?>" required placeholder="Product Cost" name="pCost">
                                ...
                                <br>
                                <div class="form-floating mb-3" >
                                    <input style="background-color:gray;color:white"type="file" class="form-control" accept=".jpeg,.jpg,.png" name="pImage" >
                                    <label for="pImage" class="form-label">Product Image</label>
                                </div>
                                <img src="img/<?php echo $pImage ?>" alt="Current Image" width="200" height="200">
                            </div>
                            <br>
